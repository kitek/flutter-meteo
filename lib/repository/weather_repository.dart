...
class WeatherRepository {
  ...
  final Map<String, Map<String, List<Weather>>> _namesCache =
      Map<String, Map<String, List<Weather>>>();
  ...
  Future<List<Weather>> findWeatherByName(String query, Country country) async {
    if (!_namesCache.containsKey(country.source)) {
      _namesCache[country.source] = Map();
    }

    final cachedResults = _namesCache[country.source][query];
    ...
    _namesCache[country.source][query] = results;
